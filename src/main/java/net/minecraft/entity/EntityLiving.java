...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    /**
     * Returns true if this entity can not attack entities of the specified class.
     */
     ...
     * or tamable)
     * @param lootingModifier level of enchantment to be applied to this drop
     */
    ...
    /**
     * Tests if this entity should pick up a weapon or an armor. Entity drops current weapon or armor if the new one is
     * better.
     */
    ...
    /**
     * Applies logic related to leash, for example dragging the entity or breaking the leash.
     */
