...
public class BlockModelCustomizer
{
    ...
    public static List<BakedQuad> getRenderQuads(List<BakedQuad> quads, IBlockAccess worldIn, IBlockState stateIn, BlockPos posIn, EnumFacing enumfacing, EnumWorldBlockLayer layer, RenderEnv renderEnv)
    {
        if (enumfacing != null)
        {
        ...
        for (int i = 0; i < quads.size(); ++i)
        {
            ...
            BakedQuad[] abakedquad = getRenderQuads(bakedquad, worldIn, stateIn, posIn, renderEnv);
    ...
    private static BakedQuad[] getRenderQuads(BakedQuad quad, IBlockAccess worldIn, IBlockState stateIn, BlockPos posIn, RenderEnv renderEnv)
    {
